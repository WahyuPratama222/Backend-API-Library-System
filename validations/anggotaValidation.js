...
const createValidateAnggota = (data) => {
  ...
  err = validateEnum(jenis_kelamin, "Jenis kelamin", [
    "Laki-laki",
    "Perempuan",
  ]);
  if (err) return err;
...
const updateRequiredValidateAnggota = (data) => {
  ...
  err = validateEnum(status_anggota, "Status Anggota", [
    "Aktif",
    "Tidak Aktif",
  ]);
  if (err) return err;
...
export {
  createValidateAnggota,
  updateRequiredValidateAnggota,
  updateOptionalValidateAnggota,
};
