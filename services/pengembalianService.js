...
const deletePengembalianService = async (id) => {
  ...
  try {
    ...
    const peminjaman = await Peminjaman.findByPk(pengembalian.id_peminjaman, {
      transaction: t,
      lock: t.LOCK.UPDATE,
    });
...
export {
  postPengembalianService,
  getPengembalianService,
  getPengembalianByIdService,
  deletePengembalianService,
};
