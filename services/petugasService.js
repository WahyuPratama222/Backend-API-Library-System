...
import {
  createValidatePetugas,
  updateRequiredValidatePetugas,
  updateOptionalValidatePetugas,
} from "../validations/petugasValidation.js";
import { validateId } from "../utils/validateIdUtil.js";
import {
  badRequestError,
  notFoundError,
  validationError,
} from "../utils/errors/errorsUtil.js";
...
const patchPetugasService = async (data) => {
  ...
  if (data.nama_petugas !== undefined)
    updateFields.nama_petugas = data.nama_petugas;
